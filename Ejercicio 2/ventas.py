...
class Interfaz():
	...
	def __init__(self):
		...
		Label(self.mainframe, text='Precio sin IVA', background='gray83').grid(column=0, row=0, padx=10, pady=10)
		...
		Label(self.mainframe, text='IVA', background='gray83').grid(column=0, row=4)
		Label(self.mainframe,text='', width=17, background='white').grid(column=1,row=4)
		Label(self.mainframe, text='Precion con IVA', background='gray83').grid(column=0, row=5, padx=10, pady=10)
